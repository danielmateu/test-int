...
export function CVPreview({ data }: CVPreviewProps) {
  ...
  return (
    ...
    >
      ...
      {/* CV Page */}
      <div className="w-full bg-white text-slate-900 shadow-2xl overflow-hidden print:overflow-visible print:shadow-none print:w-full print:max-w-none print:min-h-0 max-w-[210mm] min-h-[297mm] mx-auto box-border text-sm p-10 sm:p-14 print:py-8 print:px-12">
        {/* Header */}
                <header className="p-4 mb-4 flex justify-between items-start gap-6 border-b-2 border-slate-100 break-inside-avoid">
