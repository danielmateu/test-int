...
export function CVPreview({ data }: CVPreviewProps) {
  ...
  return (
    <div 
      className={`flex flex-col gap-8 w-full max-w-[210mm] mx-auto print:gap-0 ${data.theme.font}`}
      style={{ "--theme-color": data.theme.color } as React.CSSProperties}
    >

      {/* CV Page */}
      <div className="w-full bg-white text-slate-900 shadow-2xl overflow-hidden print:shadow-none print:w-full print:max-w-none max-w-[210mm] min-h-[297mm] mx-auto box-border p-10 sm:p-14 text-sm">
        {/* Header */}
        <header className="pb-6 mb-6 flex justify-between items-start gap-6 border-b-2 border-slate-100">
        ...
        {experience.length > 0 && (
          <section className="mb-8">
            <h2 className="text-lg font-bold uppercase tracking-wider text-[color:var(--theme-color)] border-b border-slate-300 pb-2 mb-4">
              Experiencia
            </h2>
      ...
      {/* Cover Letter Page */}
      {data.coverLetter && (
        <div className="w-full bg-white text-slate-900 shadow-2xl overflow-hidden print:shadow-none print:w-full print:max-w-none max-w-[210mm] min-h-[297mm] mx-auto box-border p-10 sm:p-14 text-sm break-before-page print:break-before-page mt-8">
