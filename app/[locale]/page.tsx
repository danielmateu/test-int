    ...
    <div className="min-h-screen bg-background font-sans selection:bg-primary/20 overflow-hidden relative">
            ...
            <div className="flex h-100 p-2 gap-4 opacity-80 select-none pointer-events-none">
              <div className="w-1/3 flex flex-col gap-4">
                ...
                <div className="space-y-3">
                  <div className="space-y-1"><div className="h-3 w-16 bg-muted-foreground/30 rounded"></div><div className="h-8 bg-muted/50 rounded-md border border-border/50"></div></div>
                  <div className="space-y-1"><div className="h-3 w-24 bg-muted-foreground/30 rounded"></div><div className="h-8 bg-muted/50 rounded-md border border-border/50"></div></div>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="space-y-1"><div className="h-3 w-12 bg-muted-foreground/30 rounded"></div><div className="h-8 bg-muted/50 rounded-md border border-border/50"></div></div>
                    <div className="space-y-1"><div className="h-3 w-12 bg-muted-foreground/30 rounded"></div><div className="h-8 bg-muted/50 rounded-md border border-border/50"></div></div>
                  </div>
                  <div className="space-y-1"><div className="h-3 w-20 bg-muted-foreground/30 rounded"></div><div className="h-20 bg-muted/50 rounded-md border border-border/50"></div></div>
                </div>
              </div>
                ...
                <div className="w-full max-w-55 bg-white shadow-xl shadow-black/10 rounded-sm p-4 flex flex-col gap-3 relative overflow-hidden">
                  <div className="flex gap-3 items-center border-b pb-3 border-gray-200">
                    ...
                    <div className="flex-1 space-y-1.5">
                      ...
                      <div className="flex gap-2"><div className="h-1.5 w-1/4 bg-slate-300 rounded"></div><div className="h-1.5 w-1/4 bg-slate-300 rounded"></div></div>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="space-y-1.5">
                      <div className="h-2 w-1/4 bg-slate-800 rounded"></div><div className="h-1.5 w-full bg-slate-200 rounded"></div><div className="h-1.5 w-5/6 bg-slate-200 rounded"></div><div className="h-1.5 w-4/6 bg-slate-200 rounded"></div>
                    </div>
                    <div className="space-y-1.5">
                      <div className="h-2 w-1/4 bg-slate-800 rounded"></div><div className="flex justify-between"><div className="h-1.5 w-1/3 bg-slate-600 rounded"></div><div className="h-1.5 w-1/6 bg-slate-300 rounded"></div></div><div className="h-1.5 w-full bg-slate-200 rounded"></div><div className="h-1.5 w-5/6 bg-slate-200 rounded"></div>
                    </div>
                    <div className="space-y-1.5">
                      <div className="flex justify-between"><div className="h-1.5 w-1/3 bg-slate-600 rounded"></div><div className="h-1.5 w-1/6 bg-slate-300 rounded"></div></div><div className="h-1.5 w-full bg-slate-200 rounded"></div><div className="h-1.5 w-4/6 bg-slate-200 rounded"></div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-24 bg-zinc-50/50 dark:bg-zinc-900/20 relative">
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[250px]">
            <motion.div whileHover={{ y: -5 }} className="md:col-span-2 row-span-1 bg-card rounded-3xl p-8 border border-border/50 shadow-sm relative overflow-hidden group">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div className="w-14 h-14 bg-primary/10 text-primary rounded-2xl flex items-center justify-center mb-4"><Layout className="w-7 h-7" /></div>
                <div>
                  <h3 className="text-2xl font-bold mb-2">{t("f1Title")}</h3>
                  <p className="text-muted-foreground">{t("f1Desc")}</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div whileHover={{ y: -5 }} className="col-span-1 row-span-1 bg-linear-to-br from-primary to-purple-600 rounded-3xl p-8 text-primary-foreground shadow-lg relative overflow-hidden">
              ...
              <div className="relative z-10 h-full flex flex-col justify-end">
                ...
                <p className="text-primary-foreground/80 text-sm">{t("f2Desc")}</p>
              </div>
            </motion.div>

            <motion.div whileHover={{ y: -5 }} className="col-span-1 row-span-1 bg-card rounded-3xl p-8 border border-border/50 shadow-sm relative overflow-hidden group">
              <div className="w-12 h-12 bg-blue-500/10 text-blue-500 rounded-xl flex items-center justify-center mb-4"><Download className="w-6 h-6" /></div>
              <h3 className="text-xl font-bold mb-2">{t("f3Title")}</h3>
              <p className="text-muted-foreground text-sm">{t("f3Desc")}</p>
            </motion.div>
            ...
            <motion.div whileHover={{ y: -5 }} className="md:col-span-2 row-span-1 bg-card rounded-3xl p-8 border border-border/50 shadow-sm relative overflow-hidden group">
              ...
              <div className="relative z-10 flex items-center gap-8 h-full">
                <div className="flex-1">
                  <div className="w-12 h-12 bg-green-500/10 text-green-500 rounded-xl flex items-center justify-center mb-4"><Zap className="w-6 h-6" /></div>
                  <h3 className="text-2xl font-bold mb-2">{t("f4Title")}</h3>
                  <p className="text-muted-foreground">{t("f4Desc")}</p>
                </div>
                <div className="hidden md:flex flex-1 items-center justify-center">
                  <div className="w-full max-w-50 space-y-3">
                    <div className="h-2 w-full bg-muted rounded-full overflow-hidden">
                      <motion.div initial={{ width: 0 }} whileInView={{ width: "100%" }} transition={{ duration: 1.5, delay: 0.5 }} className="h-full bg-green-500" />
                    </div>
                    <div className="h-2 w-4/5 bg-muted rounded-full overflow-hidden">
                      <motion.div initial={{ width: 0 }} whileInView={{ width: "80%" }} transition={{ duration: 1.5, delay: 0.7 }} className="h-full bg-primary" />
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="container mx-auto max-w-4xl px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">{t("howItWorks")}</h2>
          ...
          <div className="relative">
            ...
            <div className="space-y-12 relative">
              <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
                ...
                <div className="absolute left-0 -top-5 md:top-4 md:left-1/2 -translate-x-1/2 w-14 h-14 rounded-full bg-background border-4 border-primary flex items-center justify-center z-10 shadow-lg shadow-primary/20 font-bold text-xl text-primary ">1</div>
                <div className="md:w-1/2 md:pl-12 hidden md:block">
                  <div className="bg-card p-4 rounded-xl border shadow-sm"><div className="space-y-3 opacity-50"><div className="h-4 bg-muted rounded w-1/3"></div><div className="h-10 bg-muted rounded w-full"></div><div className="h-10 bg-muted rounded w-full"></div></div></div>
                </div>
              </motion.div>

              <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} className="relative flex flex-col md:flex-row-reverse items-start md:items-center justify-between gap-8">
                <div className="md:w-1/2 md:pl-12 text-left">
                  <h3 className="text-2xl font-bold mb-2">{t("step2Title")}</h3>
                  <p className="text-muted-foreground">{t("step2Desc")}</p>
                </div>
                <div className="absolute left-0 -top-5 md:top-0 md:left-1/2 -translate-x-1/2 w-14 h-14 rounded-full bg-background border-4 border-purple-500 flex items-center justify-center z-10 shadow-lg shadow-purple-500/20 font-bold text-xl text-purple-500">2</div>
                <div className="md:w-1/2 md:pr-12 hidden md:block text-right">
                  <div className="bg-card p-4 rounded-xl border shadow-sm flex gap-2 justify-end"><div className="w-8 h-8 rounded-full bg-blue-500"></div><div className="w-8 h-8 rounded-full bg-purple-500"></div><div className="w-8 h-8 rounded-full bg-green-500"></div></div>
                </div>
              </motion.div>

              <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
                <div className="md:w-1/2 md:pr-12 text-left md:text-right">
                  <h3 className="text-2xl font-bold mb-2">{t("step3Title")}</h3>
                  <p className="text-muted-foreground">{t("step3Desc")}</p>
                </div>
                <div className="absolute left-0 md:left-1/2 -top-5 md:top-4 -translate-x-1/2 w-14 h-14 rounded-full bg-primary text-primary-foreground border-4 border-background flex items-center justify-center z-10 shadow-lg font-bold text-xl"><CheckCircle className="w-6 h-6" /></div>
                <div className="md:w-1/2 md:pl-12 hidden md:block">
                  <Button variant="outline" className="w-full pointer-events-none h-16 text-lg rounded-xl border-primary text-primary"><Download className="mr-2" /> CV_Final.pdf</Button>
                </div>
              </motion.div>
            </div>
          </div>
      ...
      <footer className="py-12 border-t bg-background relative z-10">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          ...
          <p className="text-sm">&copy; {new Date().getFullYear()} CV AI Builder. {t("rights")}</p>
        </div>
      </footer>
